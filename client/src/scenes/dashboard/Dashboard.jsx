...
const Dashboard = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      flex: 0.5,
      sortable: false,
      // renderCell: (params) => (Array.isArray(params.value) ? params.value.length : 0),
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      <Box mt="20px" display="grid" gridTemplateColumns="repeat(12,1fr)" gridAutoRows="160px" gap="20px"
      ...
      >
        ...
        <Box gridColumn="span 8" gridRow="span 2" backgroundColor={theme.palette.background.alt} p="1rem" borderRadius="0.55rem"><OverviewChart view="sales" isDashboard={true} /></Box>
